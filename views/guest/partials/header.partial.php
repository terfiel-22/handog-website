            ...
            <div class="header-main">
                <div class="logo">
                    <a href="/" class="header-logo">
                        <img src="<?= handleImage(\Http\Services\SettingService::getLogo()["image"], "/assets/guest/img/logo/white-logo.svg") ?>" alt="logo-img" />
                    </a>
                    <a href="/" class="header-logo-2">
                        <img src="<?= handleImage(\Http\Services\SettingService::getLogo()["image"], "/assets/guest/img/logo/black-logo.svg") ?>" alt="logo-img" />
                    </a>
                </div>
