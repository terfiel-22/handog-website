                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="<?= handleFilePath($event['image'], "/assets/admin/images/user-list/user-list1.png")  ?> " alt="<?= $event['name'] ?>" class="flex-shrink-0 me-12 radius-8" style="width: 80px;">
                                                <h6 class="text-md mb-0 fw-medium flex-grow-1"><?= $event['name'] ?></h6>
                                            </div>
                                        </td>
                                        <td><?= formatDatetimeToReadable($event['date']) ?></td>
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="/admin/events/edit?id=<?= $event["id"] ?>" class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                                                ...
                                                <button
                                                    ...
                                                    onclick="deleteModalForm('/admin/events/destroy','<?= $event['id'] ?>')"
