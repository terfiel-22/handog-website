        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form method="POST">
                        ...
                        <div class="position-relative">
                            <div class="icon-field">
                                <span class="icon top-50 translate-middle-y">
                                    <iconify-icon icon="ic:outline-pin"></iconify-icon>
                                </span>
                                <input type="password" class="form-control h-56-px bg-neutral-50 radius-12" name="reset_pin" id="reset_pin" placeholder="Enter Reset PIN">
                            </div>
                            <span class="toggle-password ri-eye-line cursor-pointer position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light" data-toggle="#reset_pin"></span>
                        </div>
                        <?php if (isset($errors["reset_pin"])) : ?>
                    ...
                    <div class="mb-20">
                        <div class="position-relative">
                            <div class="icon-field">
                                ...
                                <input type="password" class="form-control h-56-px bg-neutral-50 radius-12" name="cpassword" id="cpassword" placeholder="Confirm Password">
                            </div>
                    ...
                    <button type="submit" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32" data-bs-toggle="modal" data-bs-target="#exampleModal">Reset Password</button>
