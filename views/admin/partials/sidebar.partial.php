<aside class="sidebar">
    ...
    <div>
        <a href="/admin" class="sidebar-logo">
            <img src="<?= handleImage(\Http\Services\SettingService::getLogo()["image"], "/assets/admin/images/logo.png") ?>" alt="site logo" class="light-logo">
            <img src="<?= handleImage(\Http\Services\SettingService::getLogo()["image"], "/assets/admin/images/logo-light.png") ?>" alt="site logo" class="dark-logo">
