                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="<?= handleFilePath($amenity['image'], "/assets/admin/images/user-list/user-list1.png")  ?> " alt="<?= $amenity['name'] ?>" class="flex-shrink-0 me-12 radius-8" style="width: 80px;">
