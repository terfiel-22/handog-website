        ...
        <div class="dashboard-main-body">
            ...
            <div class="card basic-data-table">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="/admin/testimonials/create" class="btn btn-primary-600 radius-8 px-20 py-11">Add</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($testimonials as $testimonial): ?>
                                    <tr>
                                        ...
                                        <td><?= $testimonial['rating'] ?> Star</td>
                                        <td><?= $testimonial['feedback'] ?></td>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="/admin/testimonials/edit?id=<?= $testimonial["id"] ?>" class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                                                ...
                                                <button
                                                    ...
                                                    onclick="deleteModalForm('/admin/testimonials/destroy','<?= $testimonial['id'] ?>')"
