...
<body>
                                ...
                                <div class="step active">
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-12">
                                            ...
                                            <select name="facility" id="facility" class="form-control">
                                                <?php foreach ($facilities as $facility): ?>
                                                    <option value="<?= $facility['id'] ?>" data-name="<?= $facility['name'] ?>" data-rate-8hrs="<?= $facility['rate_8hrs'] ?>" data-rate-12hrs="<?= $facility['rate_12hrs'] ?>" data-rate-1day="<?= $facility['rate_1day'] ?>" data-type="<?= $facility["type"] ?>" data-pax="<?= $facility["capacity"] ?>" <?= old("facility", $reservation["facility_id"]) == $facility["id"] ? "selected" : "" ?>><?= $facility['name'] ?> (<?= ucfirst($facility['type']) ?>)</option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" id="additional_bed_count" name="additional_bed_count" class="form-control" min="0" max="99" value="<?= old("additional_bed_count", $reservation['additional_bed_count']) ?>">
                                ...
                                <div class="step">
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="discounted_value" id="discounted_value" value="<?= $reservation["discounted_value"] ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            generateGuestFields(oldValues.length);
        });
    </script>
    ...
    <script>
        $(function() {
            ...
            const origFacilityId = <?= $reservation["facility_id"] ?>;
            const origDiscountedValue = <?= $reservation["discounted_value"] ?>;
