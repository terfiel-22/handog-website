 <?php
   ...
   $router->get('/event', 'guest/event.controller.php')->only('guest');
   ...
   // Events
   $router->get('/admin/events', 'admin/event/index.controller.php')->only('guest');
   $router->get('/admin/events/create', 'admin/event/create.controller.php')->only('guest');
   $router->post('/admin/events/store', 'admin/event/store.controller.php')->only('guest');
   $router->get('/admin/events/edit', 'admin/event/edit.controller.php')->only('guest');
   $router->put('/admin/events/update', 'admin/event/update.controller.php')->only('guest');
   $router->delete('/admin/events/destroy', 'admin/event/destroy.controller.php')->only('guest');

   // Faqs 
   $router->get('/admin/faqs', 'admin/faq/index.controller.php')->only('guest');
   $router->get('/admin/faqs/create', 'admin/faq/create.controller.php')->only('guest');
   $router->post('/admin/faqs/store', 'admin/faq/store.controller.php')->only('guest');
   $router->get('/admin/faqs/edit', 'admin/faq/edit.controller.php')->only('guest');
   $router->put('/admin/faqs/update', 'admin/faq/update.controller.php')->only('guest');
   $router->delete('/admin/faqs/destroy', 'admin/faq/destroy.controller.php')->only('guest');
